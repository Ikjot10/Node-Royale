...
class Game extends React.Component {
	...
	leaveGame() {
		socket.send(
			JSON.stringify({ type: "disconnect", cid: stage.cid })
		);
		socket.close();
	...
	render(props) {
		return (
			<div id="ui_servers">
				...
				<center>
					<div id="serversDiv">
						<button className="serverBtn" id="profileBtn" onClick={this.props.movetoProfile}>
							My Profile
            			</button>
						<button
							className="serverBtn"
...
class App extends React.Component {
	...
	render() {
		...
		if (inLogin) {
			...
			return <Game movetoServer={this.movetoServer} />;
		} else if (inServer) {
			return (
				<Servers
...
ReactDOM.render(<App name="app" ref={element => window.game = element} />, document.getElementById('view'));
